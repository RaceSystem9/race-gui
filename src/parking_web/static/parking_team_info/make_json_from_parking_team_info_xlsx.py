...
# 엑셀 파일 읽기
wb = load_workbook("parking_team_info.xlsx", data_only=True)
ws = wb.active
...
# JSON 저장
with open("parking_team_info.json", "w", encoding="utf-8") as f:
    json.dump(teams, f, ensure_ascii=False, indent=4)

print("parking_team_info.xlsx 파일을 성공적으로 처리했습니다.")
print(f"총 {len(teams)}개 팀 정보를 parking_team_info.json으로 저장했습니다.")